package com.example.andinovanprastya.modul4library;
...
//        Timber.d("number of faces= " + faces.size());
        ...
        if (faces.size() == 0) {
            Toast.makeText(context,"nonfacess", Toast.LENGTH_SHORT).show();
        } else {
...
//                        break;
                    ...
                    default:
                        emojiBitmap = null;
                        Toast.makeText(context, "noemoji", Toast.LENGTH_SHORT).show();
                }
